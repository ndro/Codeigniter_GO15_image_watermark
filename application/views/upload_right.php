	...
	<div class="col-lg-12 text-center v-center">
		...
		<div class="row">
			<form class="form-inline" role="form" enctype='multipart/form-data' method="post" action="<?php echo base_url(); ?>home/proses_upload">
				...
				<div class="form-group col-lg-2">
					...
					<input name="mode" readonly="true" type="hidden" value="right">
		...
		<div class="row">
			...
			<div class="col-lg-4">
				...
				<br />
				<br />
				<img class="img-responsive center-block pic" src="<?php echo base_url(); ?>assets/images/your-kanan.png" alt="Foto Kanan" width="400">
				&nbsp;
				<br />
			</div>
			<div class="col-lg-4">
